...
/*
# Seed Initial Data — Bookers Supplier + 78 Products

Inserts the Bookers supplier and all 78 products from the imported CSV.
Uses ON CONFLICT DO NOTHING so re-running is safe.
Package sizes are taken from the "Category" column of the original CSV
(the data was entered there). Categories are derived from item context.
Prices are initial wholesale estimates (GBP) — admin can edit via the
Inventory Manager.
*/

INSERT INTO suppliers (name) VALUES ('Bookers') ON CONFLICT (name) DO NOTHING;
...
FROM (VALUES
  ...
  ('ING-002','Billington''s Dark Brown Soft Natural Cane Sugar 500g','Baking & Confectionery','10 x 500g',8.00),
  ('ING-003','Billington''s Light Brown Soft Natural Cane Sugar 3kg','Baking & Confectionery','1 x 3kg',4.50),
  ('ING-004','Billington''s Light Brown Soft Natural Cane Sugar 500g','Baking & Confectionery','10 x 500g',8.00),
  ...
  ('ING-046','JR Foods 7" Pizza Box Plain Brown (100pcs)','Packaging & Equipment','1 x 100pk',22.00),
  ...
  ('ING-055','Monin Caramel Syrup 1 Litre','Drinks & Beverages','1 x 1ltr',8.50),
  ('ING-056','Mrs Elswood Burger Gherkins 670g','Condiments & Sauces','6 x 670g',12.00),
  ('ING-057','Muller Whole Milk 2 Litre','Dairy & Alternatives','4 x 2ltr',6.00),
  ...
  ('ING-077','Strathmore Still Spring Water 330ml','Drinks & Beverages','24 x 330ml',8.00),
