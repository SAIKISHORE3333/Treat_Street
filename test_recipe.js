        ...
        window.app = {
            ...
            addIngredientRow(data = { name: '', qty: '', unit: '', notes: '' }) {
                ...
                tr.innerHTML = `
                    ...
                    <td class="py-2 pr-2">
                        <input type="text" value="${data.qty}" placeholder="0" class="ing-qty w-full px-3 py-1.5 text-sm border border-slate-300 rounded focus:ring-1 focus:ring-primary focus:border-primary outline-none">
                    </td>
                    <td class="py-2 pr-2">
                        <select class="ing-unit w-full px-3 py-1.5 text-sm border border-slate-300 rounded focus:ring-1 focus:ring-primary focus:border-primary outline-none bg-white">
